...
import { SKY } from './config.js?v=8eaf432e';
  ...
  const mat = new THREE.ShaderMaterial({
    ...
    fragmentShader: `
      ...
      void main(){
        ...
        // sun disc + halo, also banded
        float sd = dot(d, normalize(uSun));
        col += vec3(1.0, 0.95, 0.82) * step(0.9975, sd) * 1.2;
        col += vec3(1.0, 0.82, 0.55) * floor(pow(max(sd, 0.0), 9.0) * 5.0) / 5.0 * 0.55;
